...
class __TwigTemplate_b34475718070a48040ddf54c3ef2bd21 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 10
        echo twig_include($this->env, $context, "evenement/_form.html.twig", ["button_label" => ""]);
        echo "
    ...
    <a href=\"";
        ...
        echo "\" class=\"bi bi-arrow-left-circle\"></a>
</div>
...
";
    ...
    {
        return array (  108 => 15,  102 => 12,  97 => 10,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
 <div style=\"margin: 400px;\">
    ...
    {{ include('evenement/_form.html.twig', {'button_label': ''}) }}

    {{ include('evenement/_delete_form.html.twig') }}
    

    <a href=\"{{ path('app_evenement_index') }}\" class=\"bi bi-arrow-left-circle\"></a>
</div>
    
{% endblock %}
", "evenement/edit.html.twig", "C:\\Users\\rayen\\Documents\\GitHub\\pi3\\TEAM_XL_projetPI_3A54\\templates\\evenement\\edit.html.twig");
    }
}
