...
class __TwigTemplate_01eecfce752a010053eed69a0d67d573 extends Template
{
    private $source;
    private $macros = [];
    ...
    <button class=\"btn\" type=\"submit\">
        <i class=\"fa-solid fa-floppy-disk\" style=\"color: #4154f1;\"></i>";
        // line 5
        echo twig_escape_filter($this->env, ((array_key_exists("button_label", $context)) ? (_twig_default_filter((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 5, $this->source); })()))) : ("")), "html", null, true);
        echo "
    </button>
";
        // line 7
...
{{ form_start(form) }}
    {{ form_widget(form) }}
    <button class=\"btn\" type=\"submit\">
        <i class=\"fa-solid fa-floppy-disk\" style=\"color: #4154f1;\"></i>{{ button_label|default() }}
    </button>
{{ form_end(form) }}
", "evenement/_form.html.twig", "C:\\Users\\rayen\\Documents\\GitHub\\pi3\\TEAM_XL_projetPI_3A54\\templates\\evenement\\_form.html.twig");
    }
}
