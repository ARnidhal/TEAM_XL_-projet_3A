 ...
 */
final class Version20240227061727 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservationservice ADD CONSTRAINT FK_505F34CA43E3E8B5 FOREIGN KEY (idserivce_id) REFERENCES category (id)');
    }
