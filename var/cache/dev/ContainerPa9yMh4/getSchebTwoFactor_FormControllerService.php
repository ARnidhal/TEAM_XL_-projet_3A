...
class getSchebTwoFactor_FormControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['scheb_two_factor.form_controller'] = new \Scheb\TwoFactorBundle\Controller\FormController(($container->services['.container.private.security.token_storage'] ?? $container->get_Container_Private_Security_TokenStorageService()), ($container->privates['scheb_two_factor.provider_registry'] ?? $container->load('getSchebTwoFactor_ProviderRegistryService')), ($container->services['scheb_two_factor.firewall_context'] ?? ($container->services['scheb_two_factor.firewall_context'] = new \Scheb\TwoFactorBundle\Security\TwoFactor\TwoFactorFirewallContext([]))), ($container->privates['security.logout_url_generator'] ?? $container->getSecurity_LogoutUrlGeneratorService()), NULL, false);
    }
}
